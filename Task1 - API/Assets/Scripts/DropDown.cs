        ...
        switch (index)
        {
            case 0:
                ...
                for (int i = 0; i < m.clients.Count; i++)
                {
                    ...
                    {
                        buttonComponent1 = newText.AddComponent<Button>();
                    }
                    ...
                    if (buttonComponent1.onClick.GetPersistentEventCount() == 0)
                    {
                        ...
                        buttonComponent1.onClick.AddListener(() => PrintClientLabel(m.clients[i].label));
                    }
            ...
            case 1:
                ...
                {
                    buttonComponent = managerText.AddComponent<Button>();
                }
            ...
            case 2:
                ...
                for (int i = 0; i < m.clients.Count; i++)
                {
                    if (!m.clients[i].isManager)
                    {
                        ...
                        {
                            buttonComponent2 = newText.AddComponent<Button>();
                        }
                        ...
                        {
                            // If onClick listener doesn't exist, add it
                            buttonComponent2.onClick.AddListener(() => PrintClientLabel(m.clients[i].label));
                        }
